...
plt.legend()
fig.savefig("Plots/Log/lambda_transmitted_tens_zoom.png")
fig.clf()
...
plt.xlabel(r"$\lambda$ / $\AA$")
plt.legend()
fig.savefig("Plots/Log/lambda_transmitted_tens_zoom_low.png")
fig.clf()
...
plt.xlabel(r"$\lambda$ / $\AA$")
plt.legend()
fig.savefig("Plots/Log/lambda_transmitted_tens_zoom_high.png")
fig.clf()
