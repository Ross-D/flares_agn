...
plt.legend()
fig.savefig("Plots/Log/lambda_total_tens_zoom.png")
fig.clf()
...
plt.legend()
fig.savefig("Plots/Log/lambda_total_tens_zoom_low.png")
fig.clf()
...
#fig.colorbar(cm.ScalarMappable(norm=norm, cmap=cmap))#, ax=ax)
plt.legend()
fig.savefig("Plots/Log/lambda_total_tens_zoom_high.png")
fig.clf()
